    ...
    <div id="page" class="page">
      ...
      <header id="site_header" class="header mobile-menu-hide">
        ...
        <div class="header-content">
          ...
          <div class="site-title-block mobile-hidden">
            ...
            <div class="site-title">Kennedy</div>
      ...
      <div class="mobile-header mobile-visible">
        ...
        <div class="mobile-logo-container">
          ...
          <div class="mobile-site-title">Kennedy</div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-8">
                      ...
                      <div class="social-links">
                        ...
                        <a href="https://www.facebook.com/kennedy.sunjoto.1"><i class="fa fa-facebook"></i></a>

                        <a href="https://www.instagram.com/kennedy_sunjoto/"><i class="fa fa-instagram"></i></a>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      ...
                      <div class="Tentang-Saya">
                        ...
                        <p>Hello , Nama saya kennedy 
                          Hobi saya bermain basket dan cita-cita saya menjadi pemain basket ternama</p>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      ...
                      <ul class="info-list">
                        ...
                        <li><span class="title">Umur</span><span class="value">16</span></li>

                        <li><span class="title">Kewarganegaraan</span><span class="value">Indonesia</span></li>

                        <li><span class="title">Alamat</span><span class="value">Bogor, Indonesia</span></li>

                        <li><span class="title">e-mail</span><span class="value"><a href="mailto:Kennedysunjoto05@gmail.com">Kennedysunjoto05@gmail.com</a></span></li>

                        <li><span class="title">Telepon</span><span class="value">+6285774413977</span></li>
                    ...
                    <div class="col-sm-6 col-md-6">
                      ...
                      <div class="contact-info-block">
                        ...
                        <div class="ci-text">
                          ...
                          <h5>Kennedysunjoto05@gmail.com</h5>
