...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Website sekolah</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>Nama User</p>
          <a href="#"><i class="fa-heart"></i> Offline</a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo site_url('Welcome/DataSiswa'); ?>"><i class="fa fa-user"></i> <span>Data siswa</span></a></li>
		<li><a href="<?php echo site_url('Welcome/DataGuru'); ?>"><i class="fa fa-user"></i> <span>Data Guru</span></a></li>


        <li class="header">Menu Tambahan</li>
       <li><a href="<?php echo site_url('User/DataUser'); ?>"><i class="fa fa-circle-o text-green"></i> <span>User</span></a></li>
